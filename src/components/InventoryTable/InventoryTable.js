    ...
    <tr className="inventory-table__row">
      <td>
        <Link
          ...
          className="inventory-table__cell link"
        >
          {inventory.item_name} <img src={forwardIcon} alt="" />
        </Link>
      </td>
      <td>
        <p className="inventory-table__cell">{inventory.category}</p>
      </td>
      <td>
        <p className="inventory-table__cell">
          <InventoryStatus status={inventory.status} />
        </p>
      </td>
      <td>
        <p className="inventory-table__cell">{inventory.quantity}</p>
      </td>
      <td>
        <p className="inventory-table__cell">{inventory.warehouse_name}</p>
      </td>
      <td>
        <div className="inventory-table__cell actions">
          <img
    ...
    <table className="inventory-table">
      <thead>
        <tr className="inventory-table__heads">
          <th>
            <h4 className="inventory-table__head first">
              INVENTORY ITEM <img src={sortIcon} alt="" />
            </h4>
          </th>
          <th>
            <h4 className="inventory-table__head">
          ...
          <th>
            <h4 className="inventory-table__head last">ACTIONS</h4>
          </th>
        </tr>
      </thead>
      <tbody>
